...
export default function ExportButtons() {
  ...
  async function exportPDF() {
    ...
    doc.setFontSize(14);
    doc.text('Informe de Evaluación de Capital Natural (mock)', 40, y);
    y += 24;

    await addSection(input, 'Mapa');
    await addSection(input2, 'Dashboard');

    doc.save('informe_regenerativo.pdf');
  }
